...
export type MediatorSendValue = React.JSX.Element | React.JSX.Element[];
        ...
        function __detailsSections() {
            __details.forEach(function (d: ReportDetailSection<T>) {
                if (d.valueProvider) {
                    ...
                    const summary = structuredClone((bs[last.name] as GroupContext<T>).all[last.current].summary);
