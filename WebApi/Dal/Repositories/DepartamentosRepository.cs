...
namespace Dal.Repositories{
  ...
  [RepoName("Dal.Repositories.DepartamentosRepository")]
  public class DepartamentosRepository : RepositoryBase {
  
    public DepartamentosRepository(DbContext context) : base(context) { }
