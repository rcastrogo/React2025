...
namespace Dal.Repositories{
  ...
  [RepoName("Dal.Repositories.CategoriasRepository")]
  public class CategoriasRepository : RepositoryBase {
  
    public CategoriasRepository(DbContext context) : base(context) { }
